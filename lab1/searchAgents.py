...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    while len(unvisitedCornersList) > 0:
        # Mahattan dustance of all corners
        distances = []
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    # We will find the farest food, using help function (at the bottom of the document)
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        "*** YOUR CODE HERE ***"
        # Uniform cost search - similar to a*, but without heuristic, which make it greedy
